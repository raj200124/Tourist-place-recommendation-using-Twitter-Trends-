...
rows=[]
list = []
name = ["#mumbaidiaries","#marinedrive","#mumbaitrip","#elephantacaves","#juhubeach","#juhuchowpattybeach","#esselworld","#sanjaygandhinationalpark"]

for tweet in tweepy.Cursor(api.search, q="#mumbaidiaries",
                   lang="en",
                   since="2018-01-01").items():
    ro = ["mumbai",tweet.text,status.created_at]
    rows.append(ro)
    print(ro)
